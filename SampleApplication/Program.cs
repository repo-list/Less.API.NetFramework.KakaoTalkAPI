...
namespace SampleApplication
{
    class Program
    {
        ...
        static void TestFriendsTabFeatures()
        {
            ...
            var friendsTab = mainWindow.Friends;
        ...
        static void TestChattingTabFeatures()
        {
            ...
            var mainWindow = KakaoTalk.MainWindow;
            var chattingTab = mainWindow.Chatting;
        ...
        static void FinalTest()
        {
            ...
            for (int i = 0; i < chatWindows.Count; i++) chatWindows[i].SendText($"카카오톡 API의 모든 기능을 테스트합니다. (Number : {i + 1}/{chatWindows.Count}, RoomName : {chatWindows[i].RoomName})");
            Thread.Sleep(1000);
            ...
            for (int i = 0; i < chatWindows.Count; i++) chatWindows[i].SendText($"카카오톡 API의 모든 기능에 대한 테스트를 종료합니다. (Number : {i + 1}/{chatWindows.Count}, RoomName : {chatWindows[i].RoomName})");
            Thread.Sleep(5000);
